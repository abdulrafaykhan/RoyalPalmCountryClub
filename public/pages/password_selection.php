...
<?php
	if(logged_in_employee() || logged_in_admin() || logged_in_member()) 
	{
...
<form  action = "password_insertion.php" method = "post">
	<fieldset>
		<legend>Please select a proper password : (min 10 characters)</legend>
			<p><label>TRP Member ID:</label></p>
			<input type = "number" name = "member_id" value = "<?php echo $_GET['member_id']; ?>">
